...
class PassengerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestRideButton.setOnClickListener {
            ...
            val passengers = passengerCountSpinner.selectedItem.toString()

            Toast.makeText(this, "Ride requested: $pickup to $dropOff for $passengers passengers", Toast.LENGTH_LONG).show()
        }
